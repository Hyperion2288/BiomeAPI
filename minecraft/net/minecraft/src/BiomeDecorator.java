...
public class BiomeDecorator
{
    ...
    public static void addDecorator(String key, int rate, WorldGenerator gen)
    {
    	if(gen == null)
    	{
    		throw new RuntimeException("You cannot pass a null generator to BiomeDecorator");
    	}
    	decoratorKeys.add(key);
    	decoratorsStatic.put(key, new BiomeDecoratorGen(rate, gen));
    	for(int i = 0; i < BiomeGenBase.biomeList.length; i++)
    	{
    		BiomeGenBase biome = BiomeGenBase.biomeList[i];
    		if(biome == null) continue;
    		biome.biomeDecorator.decorators.put(key, ((BiomeDecoratorGen)decoratorsStatic.get(key)).copy());	
    	}
    }
    ...
    public void setDecoratorRate(String key, int rate)
    {
    	...
    	if(biomeGen != null) biomeGen.rate = rate;
    }
    ...
    public BiomeDecorator(BiomeGenBase par1BiomeGenBase)
    {
        ...
        for(int i = 0; i < decoratorKeys.size(); i++)
        {
        	BiomeDecoratorGen biomeGen = (BiomeDecoratorGen)decoratorsStatic.get(decoratorKeys.get(i)); 
        	decorators.put(decoratorKeys.get(i), biomeGen.copy());
        }
    }
    ...
    protected void decorate()
    {
        ...
        for(int i = 0; i < decoratorKeys.size(); i++)
        {
        	BiomeDecoratorGen biomeGen = (BiomeDecoratorGen)decorators.get(decoratorKeys.get(i));
        	for(int j = 0; j < biomeGen.rate; j++)
        	{
                ...
                biomeGen.gen.generate(this.currentWorld, this.randomGenerator, x, y, z);
        	}
        }
